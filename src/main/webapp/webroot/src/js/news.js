    ...
    success: function (data) {
        if (data.result === "success") {
            ...
            for (var i = 0; i < data.notification.length; i++) {
                console.log("时间: " + data.notification[i].time);
                console.log("用户“" + data.notification[i].susername + "”给您在“" + data.notification[i].message.location + "”处的留言“" + data.notification[i].message.content + "”点了一个赞");
            }
